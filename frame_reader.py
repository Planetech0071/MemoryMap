...
class FrameReader:
    ...
    def __init__(
        ...
        self._cap: Optional[cv2.VideoCapture] = None        self._frame_interval = 1.0 / self.fps
    #  Context manager 
    ...
    def open(self) -> None:
        ...
        logger.info(
            "Video source opened: {} @ {}{} (target FPS: {})",
    ...
    def close(self) -> None:
        if self._cap is not None:
            self._cap.release()
            self._cap = None            logger.info("Video source closed.")
        ...
        while True:
            ...
            if not ret:
                ...
                if isinstance(self.source, str) and Path(self.source).is_file():
                    ...
                    break                # Camera read failure  retry briefly
